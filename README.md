...
This module uses [AWS CloudWatch](https://aws.amazon.com/cloudwatch/) to alert on findings from [AWS CloudTrail](https://aws.amazon.com/cloudtrail/) and notifies administrators with AWS SNS topics.
There will be one alert per finding.
